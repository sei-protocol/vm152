...
#[no_mangle]
pub extern "C" fn instantiate_v155(
    cache: *mut cache_t,
...
#[no_mangle]
pub extern "C" fn ibc_channel_open_v155(
    cache: *mut cache_t,
    checksum: ByteSliceView,
    env: ByteSliceView,
    msg: ByteSliceView,
...
#[no_mangle]
pub extern "C" fn ibc_channel_connect_v155(
    cache: *mut cache_t,
    checksum: ByteSliceView,
    env: ByteSliceView,
    msg: ByteSliceView,
...
#[no_mangle]
pub extern "C" fn ibc_channel_close_v155(
    cache: *mut cache_t,
    checksum: ByteSliceView,
    env: ByteSliceView,
    msg: ByteSliceView,
...
#[no_mangle]
pub extern "C" fn ibc_packet_receive_v155(
    cache: *mut cache_t,
    checksum: ByteSliceView,
    env: ByteSliceView,
    msg: ByteSliceView,
...
#[no_mangle]
pub extern "C" fn ibc_packet_ack_v155(
    cache: *mut cache_t,
    checksum: ByteSliceView,
    env: ByteSliceView,
    msg: ByteSliceView,
...
#[no_mangle]
pub extern "C" fn ibc_packet_timeout_v155(
    cache: *mut cache_t,
    checksum: ByteSliceView,
    env: ByteSliceView,
    msg: ByteSliceView,

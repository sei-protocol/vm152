...
lipo -output artifacts/libwasmvm155.dylib -create \
  target/x86_64-apple-darwin/release/deps/libwasmvm155.dylib \
  target/aarch64-apple-darwin/release/deps/libwasmvm155.dylib
